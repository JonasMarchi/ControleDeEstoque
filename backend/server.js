require("dotenv").config(); //arquivo de conexão com o banco
const express = require("express"); //conexão com o servidor
const cors = require("cors"); //permite as rotas dentro do servidor
const { Pool } = require("pg"); //gerenciar senhas
